...
/**
 * random server port property source
 * <br/>
 * 为了解决Eureka实例使用生成随机端口,造成Eureka实例启动端口和Tomcat服务启动端口不一致问题
 *
...
public class RandomServerPortPropertySource extends PropertySource<RandomServerPort> {
    ...
    /**
     ...
     new RandomValuePropertySource(RANDOM_SERVER_PORT_PROPERTY_SOURCE_NAME));
     log.trace("RandomServerPortPropertySource add to Environment");
     }
     **/
}
